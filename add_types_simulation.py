"""
Script pour ajouter la simulation des types et erreurs à la leçon 1 du module 2
"""
...
def add_types_simulation():
    ...
    # Créer la nouvelle simulation (order=2 car order=1 existe déjà)
